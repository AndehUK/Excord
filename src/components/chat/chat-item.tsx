...
export const ChatItem = ({
    ...
    const onMemberClick = () => {
        ...
        router.push(`/guilds/${params?.guildId}/conversations/${member.id}`);
    }
                ...
                <div className="flex flex-col w-full">
                    <div className="flex items-center gap-x-2">
                        <div className="flex items-center">
                            <p onClick={onMemberClick} className="font-semibold text-sm hover:underline hover:cursor-pointer">
                                {member.profile.name}
                            </p>
                    ...
                    {isPDF && (
                        <div className="relative w-fit pr-4 flex items-center p-2 mt-2 rounded-md bg-background/10">
                            <FileIcon className="h-10 w-10 fill-indigo-200 stroke-indigo-400" />
                            <a
                                href={fileUrl}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="line-clamp-1 ml-2 text-sm text-indigo-500 dark:text-indigo-400 hover:underline"
                            >
                                PDF File
                            </a>
                        </div>
